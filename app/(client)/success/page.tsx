    ...
    <div className="py-5 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4">
      ...
      >
        <motion.div
          ...
          className="w-20 h-20 bg-astro-purple rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Link
            href="/orders"
            className="flex items-center justify-center px-4 py-3 font-semibold bg-astro-green text-black border border-astro-green rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md"
          >
