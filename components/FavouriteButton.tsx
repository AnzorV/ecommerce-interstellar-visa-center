      ...
      {!showProduct ? (
        ...
        >
          {existingProduct ? (
            <Heart
              fill="#3A6EA5"
              className="text-gravity-blue/80 group-hover:text-gravity-blue hoverEffect mt-.5 w-5 h-5"
            />
          ) : (
            <Heart className="text-gravity-blue/80 group-hover:text-gravity-blue hoverEffect mt-.5 w-5 h-5" />
          )}
        </button>
      )}
    </>
