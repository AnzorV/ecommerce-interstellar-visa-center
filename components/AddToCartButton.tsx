    ...
    <div className="w-full h-12 flex items-center">
      {itemCount ? (
        ...
        <Button
          ...
          className={cn(
            "w-full bg-astro-green/80 text-lightBg shadow-none border border-astro-green/80 font-semibold tracking-wide text-white hover:bg-astro-green hover:border-astro-green hoverEffect",
            className
          )}
        >
          <ShoppingBag />
